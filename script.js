...
const products = [
  ...
  const renderProduct = (title, price) =>
    `<div class = "product-item">
     <img class = "imgproduct" src = "http://placehold.it/200x150" alt = "img">
              <h3 class = "head3">${title}</h3>
...
class CartItem extends Item {
  constructor(el, img = 'https://via.placeholder.com/70x100') {
    super(el, img);
